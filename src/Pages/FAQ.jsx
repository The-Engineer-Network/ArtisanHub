        ...
        <section className="bg-white py-4 px-6 md:px-16 lg:px-32">
            <div className="max-w-4xl mx-auto">
                <motion.h1
                    ...
                    className="text-4xl font-bold text-center text-orange-600 mb-3 font-aladin"
                >
                ...
                >
                    {faqs.map((faq, index) => (
                        <motion.div
                            ...
                            <div className={`overflow-hidden transition-all duration-700 ease-in-out ${activeIndex === index ? "max-h-40 opacity-100 py-3" : "max-h-0 opacity-0"
                                }`}>
